...
// --- HELPER FUNCTIONS ---
const renderHighlightedMessage = (message: string, name: string) => {
...
const generateRandomHearts = (): HeartConfig[] => {
...
// --- COMPONENTS ---
const HeartIcon: React.FC<HeartIconProps> = ({ style }) => (
  <svg
...
const App: React.FC = () => {
  const [step, setStep] = useState<'welcome' | 'name' | 'card'>('welcome');
